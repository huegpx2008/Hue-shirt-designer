...
<section className="rounded-2xl bg-white p-3 shadow-sm ring-1 ring-slate-200 md:p-4"><div className="mb-3 grid grid-cols-3 gap-2 border-b pb-3 sm:flex sm:flex-wrap sm:gap-2"><button onClick={() => restoreHistory(-1)} className="rounded-lg border px-3 py-2.5 text-sm">Undo</button><button onClick={() => restoreHistory(1)} className="rounded-lg border px-3 py-2.5 text-sm">Redo</button><button onClick={deleteSelected} className="rounded-lg border px-3 py-2.5 text-sm">Delete</button><button onClick={() => alignSelected('horizontal')} className="rounded-lg border px-3 py-2.5 text-sm">Center H</button><button onClick={() => alignSelected('vertical')} className="rounded-lg border px-3 py-2.5 text-sm">Center V</button><button onClick={() => { const next = Math.max(0.5, zoom - 0.1); setZoom(next); fabricCanvasRef.current?.setZoom(next); }} className="rounded-lg border px-3 py-2.5 text-sm">-</button><span className="inline-flex items-center px-1 text-sm">{Math.round(zoom * 100)}%</span><button onClick={() => { const next = Math.min(2, zoom + 0.1); setZoom(next); fabricCanvasRef.current?.setZoom(next); }} className="rounded-lg border px-3 py-2.5 text-sm">+</button></div>
