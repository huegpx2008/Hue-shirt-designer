...
<div className="grid gap-3 md:grid-cols-[1fr_220px]"><div className="flex items-center justify-center p-1 md:p-4"><div id="design-canvas" className="relative aspect-[420/520] w-full max-w-[620px]">{hasPreviewImage && resolvedImageUrl ? <img src={resolvedImageUrl} alt={`${selectedPreview.productName} ${selectedPreview.colorName}`} className="h-full w-full rounded-md object-contain" /> : <TshirtShape color={shirtColor} bodyPath={selectedProduct.mockups[shirtView]} view={shirtView} />}<div className="pointer-events-none absolute rounded-md border border-indigo-400/40 bg-indigo-100/10" style={{ top: designArea.top, left: designArea.left, width: designArea.width, height: designArea.height }} />
