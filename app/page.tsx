...
export default function Home() {
  ...
  ].join('\n'), [capturedDesignPreview, customerInfo.email, customerInfo.name, customerInfo.neededByDate, customerInfo.notes, customerInfo.organization, customerInfo.phone, emailSubjectLine, estimatedDecorationCost, estimatedPerShirt, estimatedSetupFee, recommendationByCost.recommendedMethod, selectedColorName, selectedProductName, selectedPreview?.styleNumber, sizeBreakdown, totalQuantity]);
