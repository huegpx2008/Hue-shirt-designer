...
export default function Home() {
  ...
  const filteredPreviewCatalog = useMemo(() => {
    ...
    return groupedStyles.filter((group) => group.styleNumber.toLowerCase().includes(query) || group.name.toLowerCase().includes(query) || group.brand.toLowerCase().includes(query) || group.items.some((item) => item.color.toLowerCase().includes(query)));
