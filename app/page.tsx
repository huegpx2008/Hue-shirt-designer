...
export default function Home() {
  ...
  const [printSizePreset, setPrintSizePreset] = useState<PrintSizePreset>('standard-front-10');
  const [customPrintWidthInches, setCustomPrintWidthInches] = useState('');
  const [customPrintHeightInches, setCustomPrintHeightInches] = useState('');
  ...
  const loadDraftFromLocal = () => {
    ...
    try {
      ...
      if (draft.printSizePreset) setPrintSizePreset(draft.printSizePreset as PrintSizePreset);
      if (typeof draft.customPrintWidthInches === 'string') setCustomPrintWidthInches(draft.customPrintWidthInches);
      if (typeof draft.customPrintHeightInches === 'string') setCustomPrintHeightInches(draft.customPrintHeightInches);
  ...
  const importQuotePackage = async (event: ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      if (quotePackage.printSizePreset) setPrintSizePreset(quotePackage.printSizePreset as PrintSizePreset);
      if (typeof quotePackage.customPrintWidthInches === 'string') setCustomPrintWidthInches(quotePackage.customPrintWidthInches);
      if (typeof quotePackage.customPrintHeightInches === 'string') setCustomPrintHeightInches(quotePackage.customPrintHeightInches);
