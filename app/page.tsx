...
type LocationSettings = { printSizePreset: PrintSizePreset; customPrintWidthInches: string; customPrintHeightInches: string; notes: string };
...
export default function Home() {
  ...
  const [locationSettings, setLocationSettings] = useState<Record<PrintLocation, LocationSettings>>({
    'left-chest': { printSizePreset: 'left-chest-3_5', customPrintWidthInches: '', customPrintHeightInches: '', notes: '' },
    'full-front': { printSizePreset: 'standard-front-10', customPrintWidthInches: '', customPrintHeightInches: '', notes: '' },
    'full-back': { printSizePreset: 'full-back-12', customPrintWidthInches: '', customPrintHeightInches: '', notes: '' },
    sleeve: { printSizePreset: 'custom', customPrintWidthInches: '', customPrintHeightInches: '', notes: '' }
  });
  ...
  const loadDraftFromLocal = () => {
    ...
    try {
      ...
      if ((draft as any).locationSettings) setLocationSettings((draft as any).locationSettings);
  ...
  const importQuotePackage = async (event: ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      if (quotePackage.locationSettings) setLocationSettings(quotePackage.locationSettings);
