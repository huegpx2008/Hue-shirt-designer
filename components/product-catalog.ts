...
export type PrintLocation = 'full-front' | 'left-chest' | 'full-back' | 'sleeve';
...
export const SAMPLE_PRODUCT_CATALOG: ReadonlyArray<ProductCatalogItem> = [
  {
    ...
    defaultPrintLocations: ['full-front', 'left-chest', 'sleeve']
  },
  {
    id: 'long-sleeve-tee',
    ...
    defaultPrintLocations: ['full-front', 'full-back', 'sleeve']
  },
  {
    id: 'hoodie',
    name: 'Hoodie',
  ...
  },
  {
    ...
    defaultPrintLocations: ['full-front', 'left-chest', 'full-back', 'sleeve']
  },
  {
    id: 'polo',
    name: 'Polo',
    ...
    defaultPrintLocations: ['left-chest', 'full-back', 'sleeve']
  }
] as const;
