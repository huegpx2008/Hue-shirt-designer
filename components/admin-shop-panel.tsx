...
const emptyStore = { id: '', name: '', slug: '', organization: '', description: '', visibility: 'unlisted' as const, opensAt: '', closesAt: '', active: false, deliveryNote: '', heroImageUrl: '' };
const emptyProduct = { id: '', title: '', slug: '', eyebrow: '', shortDescription: '', description: '', productType: 'featured' as const, storeId: '', basePrice: '0', imageUrl: '', active: false, optionsText: '' };
